...
static const ::google::protobuf::internal::MigrationSchema schemas[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 7, -1, sizeof(::auth::AuthReply)},
  { 15, -1, sizeof(::auth::AuthInfo)},
};
...
void AddDescriptorsImpl() {
  ...
  static const char descriptor[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
      ...
      "me\030\001 \001(\t\022\017\n\007pwdHash\030\002 \001(\t\"C\n\tAuthReply\022\013"
      "\n\003err\030\001 \001(\005\022\013\n\003msg\030\002 \001(\t\022\034\n\004data\030\003 \001(\0132\016"
      ".auth.AuthInfo\"\031\n\010AuthInfo\022\r\n\005token\030\001 \001("
      "\t2\216\001\n\004Auth\022+\n\006SignUp\022\016.auth.UserInfo\032\017.a"
      "uth.AuthReply\"\000\022+\n\006SignIn\022\016.auth.UserInf"
      "o\032\017.auth.AuthReply\"\000\022,\n\007SignOut\022\016.auth.A"
      "uthInfo\032\017.auth.AuthReply\"\000b\006proto3"
  };
